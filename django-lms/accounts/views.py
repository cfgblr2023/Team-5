...
def register(request):
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            print(len(user))
            for item_set in user :
                print(item_set.first_name)
                if item_set.is_lecturer is True and item_set.mentorOrStudent is None and item_set.Language==request.user.Language:
                 print('hi')
                 item_set.mentorOrStudent=request.user
                 item_set.save()
                 print(item_set.first_name)
                 break
            form.save()
